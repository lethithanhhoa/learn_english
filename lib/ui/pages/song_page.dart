...
class SongPage extends StatefulWidget {
  String bookId;
  String unitId;
  SongPage({Key key, this.bookId, this.unitId}) : super(key: key);
  @override
  SingingState createState() => SingingState();
}

class SingingState extends State<SongPage> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<Song>>(
        future: database.getSong(widget.bookId, widget.unitId),
        builder: (context, AsyncSnapshot<List<Song>> snapshot) {
          if (snapshot.data == null)
            return Center(child: CircularProgressIndicator());
          return Scaffold(
            appBar: AppBar(
              title: Text("Let's sing"),
                        ...
                        child: ListView.builder(itemBuilder: (context, index) {
                          ...
                          return Padding(
                            ...
                            child: Text(
                              ...
                              style:
                                  TextStyle(color: Colors.lightGreen[700], fontSize: 23.0),
                            ),
                          );
                        }),
                      ),
