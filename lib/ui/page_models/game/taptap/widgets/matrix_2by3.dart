...
class Matrix2By3 extends StatelessWidget {
  List<Cell> widgets;
  Matrix2By3({this.widgets});
  @override
          ...
          children: [
            Expanded(
                child: GestureDetector(
                    ...
                    child: (levelState.getIsCorrectWidget(0) == true)? Container():
                    Transform.scale(
                ...
                child: GestureDetector(
                    ...
                    child: (levelState.getIsCorrectWidget(1) == true)? Container():
                    Transform.scale(
          ...
          children: [
            Expanded(
                child: GestureDetector(
                    ...
                    child: (levelState.getIsCorrectWidget(2) == true)? Container():
                    Transform.scale(
                ...
                child: GestureDetector(
                    ...
                    child: (levelState.getIsCorrectWidget(3) == true)? Container():
                    Transform.scale(
          ...
          children: [
            Expanded(
                child: GestureDetector(
                    ...
                    child: (levelState.getIsCorrectWidget(4) == true)? Container():
                    Transform.scale(
                ...
                child: GestureDetector(
                    ...
                    child: (levelState.getIsCorrectWidget(5) == true)? Container():
                    Transform.scale(
