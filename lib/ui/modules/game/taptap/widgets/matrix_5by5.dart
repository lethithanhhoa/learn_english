...
class Matrix5By5 extends StatelessWidget {
  List<Cell> widgets;
  Matrix5By5({this.widgets});
  @override
          ...
          children: [
            Expanded(
                child: GestureDetector(
                    onTap: (!levelState.getIsFalse)
                        ? () {
                            levelState.setWidgetState(0, widgets[0].vocabulary);
                          }
                        : null,
            ...
            Expanded(
                child: GestureDetector(
                    onTap: (!levelState.getIsFalse)
                        ? () {
                            levelState.setWidgetState(1, widgets[1].vocabulary);
                          }
                        : null,
            ...
            Expanded(
                child: GestureDetector(
                    onTap: (!levelState.getIsFalse)
                        ? () {
                            levelState.setWidgetState(2, widgets[2].vocabulary);
                          }
                        : null,
            ...
            Expanded(
                child: GestureDetector(
                    onTap: (!levelState.getIsFalse)
                        ? () {
                            levelState.setWidgetState(3, widgets[3].vocabulary);
                          }
                        : null,
            ...
            Expanded(
                child: GestureDetector(
                    onTap: (!levelState.getIsFalse)
                        ? () {
                            levelState.setWidgetState(4, widgets[4].vocabulary);
                          }
                        : null,
          ...
          children: [
            Expanded(
                child: GestureDetector(
                    onTap: (!levelState.getIsFalse)
                        ? () {
                            levelState.setWidgetState(5, widgets[5].vocabulary);
                          }
                        : null,
            ...
            Expanded(
                child: GestureDetector(
                    onTap: (!levelState.getIsFalse)
                        ? () {
                            levelState.setWidgetState(6, widgets[6].vocabulary);
                          }
                        : null,
            ...
            Expanded(
                child: GestureDetector(
                    onTap: (!levelState.getIsFalse)
                        ? () {
                            levelState.setWidgetState(7, widgets[7].vocabulary);
                          }
                        : null,
            ...
            Expanded(
                child: GestureDetector(
                    onTap: (!levelState.getIsFalse)
                        ? () {
                            levelState.setWidgetState(8, widgets[8].vocabulary);
                          }
                        : null,
            ...
            Expanded(
                child: GestureDetector(
                    onTap: (!levelState.getIsFalse)
                        ? () {
                            levelState.setWidgetState(9, widgets[9].vocabulary);
                          }
                        : null,
      ...
      Expanded(
        child: Row(
          children: [
            Expanded(
                child: GestureDetector(
                    onTap: (!levelState.getIsFalse)
                        ? () {
                            levelState.setWidgetState(
                                20, widgets[20].vocabulary);
                          }
                        : null,
                    child: (levelState.getIsCorrectWidget(20) == true)
                        ? Container()
                        : Transform.scale(
                            scale: levelState.getWidgetState(20) ? 1.05 : 1.0,
                            child: Stack(
                              children: [
                                widgets[20],
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    height: MediaQuery.of(context).size.height,
                                    decoration: BoxDecoration(
                                      color: levelState.getWidgetState(20)
                                          ? Colors.yellow.withOpacity(0.3)
                                          : Colors.white.withOpacity(0),
                                      borderRadius: BorderRadius.circular(6.0),
                                    ),
            ...
            Expanded(
                child: GestureDetector(
                    onTap: (!levelState.getIsFalse)
                        ? () {
                            levelState.setWidgetState(
                                21, widgets[21].vocabulary);
                          }
                        : null,
                    child: (levelState.getIsCorrectWidget(21) == true)
                        ? Container()
                        : Transform.scale(
                            scale: levelState.getWidgetState(21) ? 1.05 : 1.0,
                            child: Stack(
                              children: [
                                widgets[21],
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    height: MediaQuery.of(context).size.height,
                                    decoration: BoxDecoration(
                                      color: levelState.getWidgetState(21)
                                          ? Colors.yellow.withOpacity(0.3)
                                          : Colors.white.withOpacity(0),
                                      borderRadius: BorderRadius.circular(6.0),
                                    ),
            ...
            Expanded(
                child: GestureDetector(
                    onTap: (!levelState.getIsFalse)
                        ? () {
                            levelState.setWidgetState(
                                22, widgets[22].vocabulary);
                          }
                        : null,
                    child: (levelState.getIsCorrectWidget(22) == true)
                        ? Container()
                        : Transform.scale(
                            scale: levelState.getWidgetState(22) ? 1.05 : 1.0,
                            child: Stack(
                              children: [
                                widgets[22],
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    height: MediaQuery.of(context).size.height,
                                    decoration: BoxDecoration(
                                      color: levelState.getWidgetState(22)
                                          ? Colors.yellow.withOpacity(0.3)
                                          : Colors.white.withOpacity(0),
                                      borderRadius: BorderRadius.circular(6.0),
                                    ),
            ...
            Expanded(
                child: GestureDetector(
                    onTap: (!levelState.getIsFalse)
                        ? () {
                            levelState.setWidgetState(
                                23, widgets[23].vocabulary);
                          }
                        : null,
                    child: (levelState.getIsCorrectWidget(23) == true)
                        ? Container()
                        : Transform.scale(
                            scale: levelState.getWidgetState(23) ? 1.05 : 1.0,
                            child: Stack(
                              children: [
                                widgets[23],
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    height: MediaQuery.of(context).size.height,
                                    decoration: BoxDecoration(
                                      color: levelState.getWidgetState(23)
                                          ? Colors.yellow.withOpacity(0.3)
                                          : Colors.white.withOpacity(0),
                                      borderRadius: BorderRadius.circular(6.0),
                                    ),
            ...
            Expanded(
                child: GestureDetector(
                    onTap: (levelState.getIsCorrectWidget(24) == null)
                        ? () {
                            levelState.setWidgetState(
                                24, widgets[24].vocabulary);
                          }
                        : null,
                    child: (levelState.getIsCorrectWidget(24) == true)
                        ? Container()
                        : Transform.scale(
                            scale: levelState.getWidgetState(24) ? 1.05 : 1.0,
                            child: Stack(
                              children: [
                                widgets[24],
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    height: MediaQuery.of(context).size.height,
                                    decoration: BoxDecoration(
                                      color: levelState.getWidgetState(24)
                                          ? Colors.yellow.withOpacity(0.3)
                                          : Colors.white.withOpacity(0),
                                      borderRadius: BorderRadius.circular(6.0),
                                    ),
